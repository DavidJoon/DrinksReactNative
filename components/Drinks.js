...
export default function Prata(){
  return(
    ...
    <ScrollView>
    <Text style={styles.categoriav}>Dry Martini</Text>
    <Image style={styles.img} source={require('../assets/dri1.jpg')}></Image>
    <Text style={styles.preco}>R$ 18,00</Text>
    <Separador/>

    <Text style={styles.categoriav}>Cosmopolitan</Text>
    <Image style={styles.img} source={require('../assets/dri2.jpg')}></Image>
    <Text style={styles.preco}>R$ 28,00</Text>
    <Separador/>

     <Text style={styles.categoriav}>Negroni</Text>
    <Image style={styles.img} source={require('../assets/dri3.jpg')}></Image>
    <Text style={styles.preco}>R$ 33,00</Text>
    <Separador/>
